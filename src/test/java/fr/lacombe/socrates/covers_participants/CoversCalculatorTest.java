...
public class CoversCalculatorTest {
    ...
    @Test
    public void should_calculate_the_number_of_hot_and_cold_covers_for_one_participant_2() {
        final Participant participant = Participant.of(
                Email.of("toto@toto.fr"),
                Diet.PESCETARIAN,
                LocalDateTime.of(2018, Month.NOVEMBER, 1, 18, 0),
        ...
        assertThat(result).isEqualTo(Covers.of(0, 6));
    }

    @Test
    public void should_calculate_the_number_of_hot_and_cold_covers_for_one_participant_3() {
        final Participant participant = Participant.of(
                Email.of("toto@toto.fr"),
                Diet.PESCETARIAN,
    ...
    @Test
    public void should_calculate_the_number_of_hot_and_cold_covers_for_one_participant_4() {
        final Participant participant = Participant.of(
                Email.of("toto@toto.fr"),
                Diet.PESCETARIAN,
                LocalDateTime.of(2018, Month.NOVEMBER, 1, 18, 0),
